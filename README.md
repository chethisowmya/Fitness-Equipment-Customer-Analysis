# 🏃 Fitness-Equipment-Customer-Analysis
...
Fitness-Equipment-Customer-Analysis/
│
├── fitness_equipment_customer_analysis.ipynb
├── README.md
├── requirements.txt
├── .gitignore
├── Images/
...
3. Open fitness_equipment_customer_analysis.ipynb using Jupyter Notebook or Google Colab.
